...
<head>
	...
	<title>Next | Email Template</title>
	<style type="text/css">
		/*////// RESET STYLES //////*/
				...
				<tr>
					<td>
						...
						<table class="table1" width="520" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
							...
							<tr>
								<td align="center">
									<div class="editable-img" href="">
										<img editable="true" mc:edit="image003" src="http://digitar.nu/images/logo-white.png" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="">
									</div>
								</td>
							</tr>
								...
								<td mc:edit="text001" align="center" class="text_color_ffffff" style="color: #ffffff; font-size: 30px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text">
										<span class="text_container">
											<multiline>Nieuwe documenten</multiline>
										</span>
									</div>
								</td>
							</tr>
						...
						</tbody></table><!-- END inner container -->
					</td>
				</tr>
				<!-- padding-bottom -->
				<tr><td height="60"></td></tr>
					...
					<td>
						...
						<table class="table1" width="520" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
							...
							<tr>
								<td>
									<!-- table  -->
									<table width="100%" class="" align="left" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #e6e6e6; padding-bottom: 40px; border-radius: 5px">
										<tbody><tr bgcolor="#fafafa" style="border: 1px solid #e6e6e6;">
											<td mc:edit="text007" align="left" class="text_color_303f9f" style="padding-top: 15px; padding-bottom: 15px;padding-right: 10px;padding-left: 10px;color: #303f9f; font-size: 12px; font-weight: 400; font-family: 'Open Sans', Helvetica, sans-serif; mso-line-height-rule: exactly;">
												<div class="editable-text">
													<span class="text_container">
							...
							<tr>
								<td>
									<!-- column-1  -->
									<table class="table1-2" width="320" align="left" border="0" cellspacing="0" cellpadding="0">
										<tbody><tr>
											<td mc:edit="text003" align="left" class="center_content text_color_282828" style="color: #282828; font-size: 14px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
												<div class="editable-text">
													<span class="text_container">
														<multiline>Meer weten?</multiline>
													</span>
												</div>
											</td>
										</tr>
										...
										<tr>
											<td mc:edit="text004" align="left" class="center_content text_color_b0b0b0" style="color: #b0b0b0; font-size: 14px;line-height: 2; font-weight: 300; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
												<div class="editable-text" style="line-height: 2;">
													<span class="text_container">
														<multiline>Login uw Digitar om de documenten te bekijken.</multiline>
													</span>
												</div>
											</td>
										</tr>
									...
									<!-- column-2  -->
									<table class="table1-3" width="136" align="left" border="0" cellspacing="0" cellpadding="0">
													...
													<tbody><tr>
														<td mc:edit="text013" align="center" valign="middle" style="color: #ffffff; font-size: 12px; font-weight: 400; font-family: 'Open Sans', Helvetica, sans-serif; mso-line-height-rule: exactly;" class="text_color_282828">
															<div class="editable-text">
																<span class="text_container">
																	<multiline>
																		<a href="https://login.digitar.nu" style="text-decoration: none; color: #ffffff;">Inloggen</a>
																	</multiline>
																</span>
															</div>
														</td>
		...
		<td>
			...
			<table class="table1" width="600" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
				...
				<tr>
					<td>
						<!--  column-1 -->
						<table class="table1-2" width="470" align="left" border="0" cellspacing="0" cellpadding="0">
							<tbody><tr>
								<td mc:edit="text010" align="left" class="center_content text_color_929292" style="color: #929292; font-size: 14px; line-height: 2; font-weight: 400; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
												U ontvangt deze email omdat u een account heeft op <a href="https://www.digitar.nu" style="color: #303f9f;text-decoration: none;"> Digitar</a>
											</multiline>
										</span>
									</div>
								</td>
