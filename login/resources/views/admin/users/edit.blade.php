	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="controls">{{ html()->select('oid', $organizations, $user->oid)->style('width:100%') }}</div>
			</div>
			<div class="form-group">
				<label class="form-label">Gebruikersnaam</label>
				<div class="controls">{{ html()->text('username', $user->username)->class('form-control')->maxlength('24') }}</div>
			</div>
			<div class="row">
  				<div class="col-md-8">
					<div class="form-group">
