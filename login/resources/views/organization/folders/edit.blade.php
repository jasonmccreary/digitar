...
@section('content')
	...
	<div class="form-group">
		<div class="form-group">
			...
			{{ html()->select('parent', $folders, $folder->pid)->style('width:100%;')->id('folderSelect') }}
		</div>
		<div class="input-group">
			...
			{{ html()->text('mapname', $folder->name)->class('form-control')->placeholder('Map naam') }}
		</div>
		{{ html()->hidden('color', $folder->color)->class('form-control')->id('colorpickerdata') }}
	</div>
	<div class="form-group">
		<div class="checkbox check-success 	">
			{{ html()->checkbox('geboekt', $folder->bookedcheck, 1)->id('geboekt') }}
