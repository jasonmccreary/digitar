...
Route::get('admin', function() {
	...
	Route::get('admin/organizations', function() {
		$o = new Organizations();
        return View::make('admin.organizations.overview', array(
        	'title' => 'Organisaties',
        	'organizations' => $o->all()
        ));
	})->before('auth');
		...
		*/
		Route::get('admin/organization/edit/{id}', function($id) {
			$o = new Organizations();
			$org = $o->find($id);
			return View::make('admin.organizations.edit', array(
		...
		*/
		Route::get('admin/organization/delete/{id}', function($id) {
			$o = new Organizations();
			$org = $o->find($id);
			return View::make('admin.organizations.delete', array(
	...
	Route::get('admin/users', function() {
		...
		$o = new Organizations();
        return View::make('admin.users.overview', array(
		...
		*/
		Route::get('admin/user/add', function() {
			...
			if (count($aOrganizations) > 0) {
				...
				return View::make('admin.users.add', array(
		...
		Route::post('admin/user/add', array(
			'before' => 'auth',
		...
		*/
		Route::get('admin/user/delete/{id}', function($id) {
			$u = new User();
			$user = $u->find($id);
			return View::make('admin.users.delete', array(
...
Route::get('admin/client/details/{id}', function($id) {
	...
	return View::make('admin.clientpopup', array(
		'trueblank' => true,
		'user' => $user,
		'subuser' => $subuser,
		'dirsize' => $sizeReturn
...
Route::get('admin/tools/forwardcheck', function() {
	...
	return View::make('admin.tools.checkforwarders', array(
		'title' => 'Check e-mail forwarders',
		'users' => ToolsController::checkForwarders()
	));

})->before('auth');
	Route::post('admin/tools/forwardcheck', array(
		'before' => 'auth',
...
Route::get('admin/tools/ftpcheck', function() {
	...
	return View::make('admin.tools.ftpcheck', array(
		'title' => 'Check FTP accounts',
		'users' => ToolsController::checkFtp()
	));

})->before('auth');
	Route::post('admin/tools/ftpcheck', array(
		'before' => 'auth',
