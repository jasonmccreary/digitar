...
$(document).ready(function () {
    ...
    jQuery('.page-sidebar li > a').on('click', function (e) {
        ...
        if ($(this).attr('href') != 'javascript:;' && (e.target.nodeName != 'SPAN' || e.target.textContent != '')) { return; }
    ...
    var $pageurl = $('cururl').attr('data');
    $('.page-sidebar a').each(function() {
        if ($(this).attr('href') == $pageurl) {
            $(this).parent().addClass('open');
            $(this).find('.arrow').addClass('open');
            if ($(this).parent().parent().hasClass('sub-menu')) {
                $(this).parent().parent().prev().find('.arrow').addClass('open');
                $(this).parent().parent().parent().addClass('open');
                $(this).parent().parent().slideDown(200, function () {
                    handleSidenarAndContentHeight();
                });
            }
            $(this).parent().find('.sub-menu').slideDown(200, function () {
                handleSidenarAndContentHeight();
            });
        }
    });
   ...
   // initMainMenu();
    ...
    $(window).bind('enterBreakpoint320', function () {
        ...
        $('#main-menu-toggle-wrapper2').show();
    ...
    $(window).bind('exitBreakpoint320', function () {
        ...
        $('#main-menu-toggle-wrapper2').hide();
    ...
    var ctrlapress = false;
    $('*').bind('keyup', 'ctrl+a', function selectallrows() {
        if (ctrlapress == false) {
            $('table.dataTable > tbody > tr:not(.checkedRow)').each(function() {
                $(this).trigger('click');
            });
            ctrlapress = true;
        }else {
            $('table.dataTable > tbody > tr.checkedRow').each(function() {
                $(this).trigger('click');
            });
            ctrlapress = false;
        }
...
function toggleChat(){
         ...
         if($('body').hasClass('open-menu-right')){
            ...
            timer= setTimeout(function(){
                ...
                $(document).trigger('setMessagesRead');
            }, 300);
        ...
        $('#main-chat-wrapper .user-details-wrapper.active').each(function() {
