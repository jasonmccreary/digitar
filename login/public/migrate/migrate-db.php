...
$con1 = mysql_connect('localhost','digitarb_super','diehard') or die(mysql_error());
mysql_select_db('digitarb_archive',$con1) or die(mysql_error());

$con2 = mysql_connect('localhost','digitar_site','46016A9f') or die(mysql_error());
mysql_select_db('digitar_archief',$con2) or die(mysql_error());


$usersquery = mysql_query("select * from users",$con2) or die(mysql_error());
